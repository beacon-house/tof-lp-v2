    ...
    <section className="relative min-h-screen flex items-center justify-center bg-cream pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-content mx-auto px-6 md:px-8 lg:px-12 py-6 md:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-[1.75rem] leading-[1.35] md:text-4xl md:leading-[1.3] lg:text-5xl lg:leading-[1.3] font-serif font-bold text-navy mb-4 md:mb-5 opacity-0 animate-fade-in-up-delay tracking-tight">
          ...
          <p className="text-sm md:text-lg lg:text-xl text-navy/70 mb-3 md:mb-4 leading-[1.65] md:leading-[1.7] font-light opacity-0 animate-fade-in-up-delay-2 max-w-2xl mx-auto">
            For most families, the real challenge isn't marks. It's <span className="cursive-keyword">clarity</span>.
          </p>

          {/* Target audience text */}
          <p className="text-xs md:text-sm text-navy/60 mb-8 md:mb-10 opacity-0 animate-fade-in-up-delay-2">
            Designed for ambitious IB and IGCSE families across Grades 8–12.
          </p>

          {/* Trust stat boxes */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-10 opacity-0 animate-fade-in-up-delay-2 max-w-4xl mx-auto">
            {/* Box 1 */}
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-center mb-3">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-navy" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" />
                </svg>
              </div>
              <div className="text-center">
                <p className="font-bold text-base md:text-lg text-navy mb-1">620+ Ivy League</p>
                <p className="text-xs md:text-sm text-navy/60">admits</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="text-center">
                <p className="font-bold text-base md:text-lg text-navy mb-1">35+ IB & IGCSE</p>
                <p className="text-xs md:text-sm text-navy/60">schools</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="text-center">
                <p className="font-bold text-base md:text-lg text-navy mb-1">FAO-led</p>
            ...
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="text-center">
                <p className="font-bold text-base md:text-lg text-navy mb-1">Founder-led</p>
